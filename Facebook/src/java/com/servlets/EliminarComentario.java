...
public class EliminarComentario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        this.eliminarComentario(uCorreo, sCorreo, index);
    ...
    private void eliminarComentario(java.lang.String uCorreo, java.lang.String sCorreo, int pos) {
        ...
        port.eliminarComentario(uCorreo, sCorreo, pos);
    }
